...
2. **Em dashes**: remove all of them. Replace with commas, periods, or colons. Zero tolerance.
3. **Missing contractions**: "do not" becomes "don't", "you will" becomes "you'll", "it is" becomes "it's", "we are" becomes "we're", etc.
...
8. **Passive voice**: flip to active. "Videos are created by our engine" becomes "Our engine creates videos."
